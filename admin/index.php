  ...
  <div class="box">
    ...
    <dialog id="shiftDialog">
      <form action="" id="shiftDialogForm">
        <p>
          Create shift
          <input type="text" name="" id="searchEmployee" placeholder="Search employee" onkeyup="Search()" />
        </p>
    ...
    <dialog id="newEmployeeDialog">
      <form action="../includes/signup.inc.php" method="POST" id="newEmployeeDialogForm">
        <p>
          Auth new Employee
        </p>
        <input type="text" placeholder="Name" name="name" id="NewEmployeeNameInput">
        <input type="text" placeholder="Login" name="login" id="NewEmployeeLoginInput">
        <input type="password" placeholder="Password" name="password" id="NewEmployeePasswordInput">
        <input type="file" accept="image/png, image/gif, image/jpeg" name="avatar_url" placeholder="photo_file" id="NewEmployeeURLInput">
...
>>>>>>> 371572bbdefdcf0ae1013835b757ad5ab153e641
        ...
        <div class="flex">
          <button id="discardNewEmployee">Discard</button>
          <button type="submit" name="submit" id="submitNewEmployee">Submit new Employee</button>
        </div>
      </form>
    </dialog>
  </div>
